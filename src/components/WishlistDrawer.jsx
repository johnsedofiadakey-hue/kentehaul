                        ...
                        <div className="p-6 border-b border-gray-50 flex items-center justify-between bg-white sticky top-0 z-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">Saved Items</p>
                                </div>
                            </div>
                                        ...
                                        >
                                            ...
                                            <div className="flex-grow flex flex-col justify-between py-1">
                                                <div>
                                                    ...
                                                    <p className="text-lg font-black mt-0.5" style={{ color: siteContent?.secondaryColor || '#f59e0b' }}>₵{product.price.toLocaleString()}</p>
                                                </div>
