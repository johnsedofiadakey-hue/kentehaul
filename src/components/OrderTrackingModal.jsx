                    ...
                    return (
                      <div key={step} className="flex items-center gap-4">
                        <div
                          ...
                          style={{
                            backgroundColor: isCompleted ? (isCurrent ? (siteContent?.secondaryColor || '#f97316') : '#10b981') : undefined,
                            boxShadow: isCurrent ? `0 0 20px ${(siteContent?.secondaryColor || '#f97316')}40` : 'none',
