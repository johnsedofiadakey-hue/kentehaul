...
import { Camera, MessageCircle, Edit, Trash2, CheckCircle, Loader2, Plus, X, Tag, ChevronDown, ChevronRight, AlertCircle, Clock } from 'lucide-react';
                        ...
                        <div className="md:col-span-2 bg-amber-50/50 p-6 rounded-[30px] border border-amber-100/50 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-center gap-4">
                                <button 
                                    ...
                                    className={`w-14 h-8 rounded-full transition-all relative ${productForm.isPreorder ? 'bg-amber-500' : 'bg-gray-200'}`}
                                >
